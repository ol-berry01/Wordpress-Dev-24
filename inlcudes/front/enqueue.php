<?php
    ...
    function wp_dev24_enqueue() {
        ...
        wp_enqueue_style( 'wp_dev24_rubik_and_pacifico' );
        wp_enqueue_style( 'wp_dev24_bootstrap_icons' );
        wp_enqueue_style( 'wp_dev24_theme' );
    }
